// findCountriesAll() {
//   const all = countriesAll()
//   let fixedCountries = all.map(item => {
//     return {
//       name: item.translations.es || item.name,
//       code: item.alpha3Code,
//       callingCode: item.callingCodes[0],
//       flag: item.flag
//     }
//   })
//   let fixedLanguages = all.map(item => {
//     return item.languages.map(item2 => {
//       return {
//         code: item2.iso639_2,
//         name: item2.name,
//       }
...
//
//   let differents = []
//   fixedLanguages.forEach(item => {
//     if (differents.filter(i => i.code === item.code).length === 0) {
//       differents.push(item)
//     }
//   })
//
//
//   this.$axios.post(`country/new`, fixedCountries).then(response => {
//     console.log(response)
//   }).catch(error => {
//     console.log(error)
//   })
//   this.$axios.post(`languages`, differents).then(response => {
//     console.log(response)
//   }).catch(error => {
//     console.log(error)
//   })
