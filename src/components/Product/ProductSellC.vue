        ...
        <div class="col-12">
          <q-card flat square class="bg-darkless-blue no-padding">
            <q-toolbar>
              ...
              <q-space/>
              <q-btn flat round dense color="info" icon="mdi-keyboard-backspace" :disable="part === 1"
                     @click="part = 1"/>
...
export default {
  ...
  methods: {
    ...
    async submit() {
      ...
      delete obj.lote.tags
      delete obj.product.lotes
      console.log(obj)
      const a = await updateStock(objectToJSON(obj))
      console.log(a)
      this.part = 0;
      this.selling = false
      this.tag = ''
